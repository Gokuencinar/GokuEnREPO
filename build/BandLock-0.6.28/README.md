# BandLock 0.6.28 Global App

BandLock 0.6.28 moves the public tweak out of the iOS Settings app and into a dedicated UIKit application installed on the Home Screen.

### 0.6.28 Field Test diagnostic

- Diagnostic candidate focused on opening Apple's Field Test menu on iOS 16.3.
- Field Test now attempts the actual `*3001#12345#*` service code through CoreTelephony / TelephonyUtilities instead of treating a hidden bundle launch request as success.
...
BandLock 0.6.28 continues to target LTE/4G band control only; it does not claim 5G NR band locking.
