# BandLock 0.6.34 Global App — RootHide

This is the **RootHide** build of BandLock 0.6.34. It keeps the validated RootHide IPC/socket behavior and upgrades the existing `com.gokuencinar.bandlock` package.
