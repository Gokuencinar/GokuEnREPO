# BandLock 0.6.34 Global App — Dopamine rootless

This is the **Dopamine rootless** build of BandLock 0.6.34. It uses normal rootless `/var/jb` packaging and direct shared `/tmp` IPC; it does not link or call RootHide/libroothide.
...
BandLock 0.6.34 continues to target LTE/4G band control only; it does not claim 5G NR band locking.
