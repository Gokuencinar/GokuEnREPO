...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0 && indexPath.row == 0) return [self valueCell:@"BandLock Global" detail:[NSString stringWithFormat:@"%@ · Dopamine", version] symbol:@"antenna.radiowaves.left.and.right" disclosure:NO];
