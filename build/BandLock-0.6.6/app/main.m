...
int main(int argc, char *argv[]) {
    BLStartupLog("0.6.6 enter main\n");
    @autoreleasepool {
        BLStartupLog("0.6.6 autoreleasepool ready\n");
        BLStartupLog("0.6.6 before UIApplicationMain\n");
        int result = UIApplicationMain(argc, argv, nil, @"BLAppDelegate");
        BLStartupLog("0.6.6 UIApplicationMain returned\n");
        return result;
    }
}
