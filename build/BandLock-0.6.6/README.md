# BandLock 0.6.6 Global App

BandLock 0.6.6 moves the public tweak out of the iOS Settings app and into a dedicated UIKit application installed on the Home Screen.
...
- No PreferenceLoader dependency and no Settings PreferenceBundle in 0.6.6.
...
BandLock 0.6.6 continues to target LTE/4G band control only; it does not claim 5G NR band locking.
