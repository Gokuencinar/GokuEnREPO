# BandLock 0.6.27 Global App

BandLock 0.6.27 moves the public tweak out of the iOS Settings app and into a dedicated UIKit application installed on the Home Screen.

### 0.6.27 release candidate

- Release candidate after on-device validation of refresh, LTE/automatic RAT switching, LTE band apply/restore and Field Test IPC.
...
BandLock 0.6.27 continues to target LTE/4G band control only; it does not claim 5G NR band locking.
