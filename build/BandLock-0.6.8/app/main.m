...
int main(int argc, char *argv[]) {
    BLStartupLog("0.6.8 enter main\n");
    @autoreleasepool {
        BLStartupLog("0.6.8 autoreleasepool ready\n");
        BLStartupLog("0.6.8 before UIApplicationMain\n");
        int result = UIApplicationMain(argc, argv, nil, @"BLAppDelegate");
        BLStartupLog("0.6.8 UIApplicationMain returned\n");
        return result;
    }
}
