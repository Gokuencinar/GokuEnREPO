...
- (void)viewDidLoad {
    [super viewDidLoad];
    BLProbeLog("control viewDidLoad begin\n");
    ...
    [self buildUI];
    [self refreshDisplay];
    BLProbeLog("control viewDidLoad complete\n");
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        BLProbeLog("auto refresh dispatch fired\n");
...
- (void)buildUI {
    ...
    version.text = @"BandLock Global 0.6.8 · iOS 16 compatibility build";
