# BandLock 0.6.24 Global App

BandLock 0.6.24 moves the public tweak out of the iOS Settings app and into a dedicated UIKit application installed on the Home Screen.

### 0.6.24 diagnostic IPC hardening
...
BandLock 0.6.24 continues to target LTE/4G band control only; it does not claim 5G NR band locking.
