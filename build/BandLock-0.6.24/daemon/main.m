...
static NSDictionary *BLHandleRequest(NSDictionary *request) {
    @try {
        ...
        if ([command isEqualToString:@"apply"]) {
            ...
            for (NSInteger attempt = 1; attempt <= 12; attempt++) {
                ...
                // Retry once against a fresh CT query after 1.5 seconds. Do
                // not repeatedly rewrite the modem while it is converging.
                if (attempt == 3) {
